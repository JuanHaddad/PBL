    // Parâmetros recebidos do back-end
    ...
    const eixoYFixo = 0;  // Fixo no eixo Y
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            {
                label: 'Ponto em Movimento no Eixo X',
                data: [{ x: 0, y: eixoYFixo }],  // Inicialmente em (x = 0, y = eixoYFixo)
    ...
    function atualizarGrafico() {
        if (t <= duracaoSimulacao) {
            ...
            // O ponto vermelho se move ao longo do eixo X com o tempo
            let posicaoX = t / duracaoSimulacao;  // O ponto se move de 0 a 1 no eixo X
            chart.data.datasets[1].data = [{ x: posicaoX, y: eixoYFixo }];
